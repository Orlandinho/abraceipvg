		...
		<form method="post" action="/cadastro">
		  	...
		  	<div class="form-row">
		    	...
		    	<div class="form-group col-md-4">
		      		...
		      		<div class="input-group">
		      			<input type="text" class="form-control mr-2" name="cep" id="inputZip" pattern="[0-9]{5}-[0-9]{3}" title="Padrão: 00000-000" placeholder="00000-000">
		  	...
		  	<div class="form-row">
		    	...
		    	<div class="form-group col-md-3">
		      		...
		      		<input type="text" class="form-control" id="inputTel" name="tel" pattern="[0-9]{4}-[0-9]{4}" title="Padrão: 0000-0000" placeholder="0000-0000">
		    	</div>

		    	<div class="form-group col-md-3">
		      		<label for="inputCel">Celular</label>
		      		<input type="text" class="form-control" id="inputCel" name="cel" pattern="[0-9]{5}-[0-9]{4}" title="Padrão: 00000-0000" placeholder="00000-0000">
		    	</div>
		  	</div>
			...
			<div class="form-row ml-1 my-2">
				<div class="custom-control custom-checkbox">
					<input type="checkbox" class="custom-control-input" name="membro" id="membro" value="1">
		  	...
		  	<div class="border col-sm-5">
				...
				<div class="row my-2 justify-content-center-md">
					<div class="custom-control custom-checkbox ml-4">
